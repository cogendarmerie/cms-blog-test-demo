...
$recentsArticles = $database->get_data("blog_articles", "*", "", "5", "DESC", "id");
?>
<main>
    <!-- Trending Area Start -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="slider-active">
                            <!-- Single -->
                            <?php
                            foreach($recentsArticles as $article)
                            {
                                ?>
                                <div class="single-slider">
                                    <div class="trending-top mb-30">
                                        <div class="trend-top-img">
                                            <img src="<?php echo $article['illustration_url'] ?>" alt="">
                                            <div class="trend-top-cap">
                                                <span class="bgr" data-animation="fadeInUp" data-delay=".2s" data-duration="1000ms"><?php echo $article['categorie'] ?></span>
                                                <h2><a href="/articles/view/<?php echo $article['id'] ?>" data-animation="fadeInUp" data-delay=".4s" data-duration="1000ms"><?php echo $article['title'] ?></a></h2>
                                                <p data-animation="fadeInUp" data-delay=".6s" data-duration="1000ms">by <?php echo $article['author'] ?>  -  <?php echo $article['timestamp'] ?> </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
