                            ...
                            <div class="col-12">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="row">
                                            <div class="p-3">
                                                <p class="fw-bold">Accueil</p>
                                                <br>
                                                <a href="/articles/create" class="genric-btn primary radius">Créer un article</a>
                                                <a href="/articles/list" class="genric-btn success-border radius">Lister les articles</a>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Card two -->
